...
impl NearAppsContract {
    ...
    // Write a function to get the required tags
    pub fn get_required_tags(&self) -> (String, String, String) {
        (self.person_tag.clone(), self.company_tag.clone(), self.purpose_tag.clone())
    }
    ...
    pub fn my_callback(&self) -> String {
        ...
        env::log(self.get_required_tags().as_bytes());
    }
}
